  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Fortaleciendo conceptos sobre el dengue
        p.mb-4 #[b Objetivo] Reforzar los elementos conceptuales sobre el dengue tomando como base las políticas de salud establecidas.
